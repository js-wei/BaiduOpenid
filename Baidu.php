...
class Baidu
{
    ...
    public function __construct()
    {
    	...
    	$this->clientSecret = C('BaiduOpenid.clientSecret');
    	$this->redirectUri = C('BaiduOpenid.redirectUri');
	...
	public function getUserInfo(){
		...
		// check whether it is a CSRF attack request
		if ($code && $code != $this->store->get('code')) {p(1);die;
			$oauth2 = $this->getBaiduOAuth2Service();
			$session = $oauth2->getAccessTokenByAuthorizationCode($code);
